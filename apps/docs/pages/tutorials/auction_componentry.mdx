...
This tutorial will walk you through building a custom auction component for your Nouns Builder DAO. This is a React specific tutorial that leverages [Next.js](https://nextjs.org/) (Next) and its [App Router](https://nextjs.org/docs/app). Additionally, styling is accomplished with [Tailwind CSS](https://tailwindcss.com/), but any other approach will work just fine.
