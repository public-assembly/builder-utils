...
This tutorial will walk you through building a custom auction component for your DAO using the builder-utils package. This is a React specific tutorial that leverages Next.js.
...
<Tabs items={['pnpm', 'npm', 'yarn']}>
  ...
  <Tab>``` yarn add @public-assembly/dao-utils ```</Tab>
</Tabs>
...
Builder utils provides a collection of provider components used to dynamically pass data about your DAO throughout an application. You can configure these provider components by first navigating to your `_app.tsx` file and then wrapping your components with the `ManagerProvider` component.
...
Create a new directory called `components` and within it create a React component called `Artwork.tsx`. This component will be responsible for rendering the daily artwork of your DAO.
