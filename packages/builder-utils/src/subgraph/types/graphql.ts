  ...
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'DaoAddresses' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'id' } },
        ...
        selections: [
          {
            ...
            selectionSet: {
              kind: 'SelectionSet',
              selections: [
                { kind: 'Field', name: { kind: 'Name', value: 'treasuryAddress' } },
                { kind: 'Field', name: { kind: 'Name', value: 'auctionAddress' } },
                { kind: 'Field', name: { kind: 'Name', value: 'governorAddress' } },
                { kind: 'Field', name: { kind: 'Name', value: 'metadataAddress' } },
              ],
            },
          },
        ],
  ...
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'DaoProposals' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'id' } },
              ...
              selections: [
                {
                  ...
                  arguments: [
                    ...
                    },
                    {
                      ...
                      value: { kind: 'EnumValue', value: 'timeCreated' },
                    },
                  ],
                  selectionSet: {
                    kind: 'SelectionSet',
...
} as unknown as DocumentNode<DaoProposalsQuery, DaoProposalsQueryVariables>
  ...
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'ProposalDetails' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
  ...
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'ProposalVotes' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'proposalId' } },
...
} as unknown as DocumentNode<ProposalVotesQuery, ProposalVotesQueryVariables>
