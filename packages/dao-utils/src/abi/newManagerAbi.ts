export const newManagerAbi = [
  ...
  { inputs: [], name: 'UNSUPPORTED_UUID', type: 'error' },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: 'address', name: 'metadata', type: 'address' },
      { indexed: false, internalType: 'address', name: 'auction', type: 'address' },
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: false, internalType: 'address', name: 'baseImpl', type: 'address' },
      { indexed: false, internalType: 'address', name: 'upgradeImpl', type: 'address' },
    ],
  ...
  },
  {
    inputs: [
      ...
      {
        components: [{ internalType: 'bytes', name: 'initStrings', type: 'bytes' }],
    ...
    outputs: [
      {
        components: [
          ...
          { internalType: 'string', name: 'auction', type: 'string' },
          { internalType: 'string', name: 'treasury', type: 'string' },
          { internalType: 'string', name: 'governor', type: 'string' },
        ],
