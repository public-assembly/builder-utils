export const governorAbi = [
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: false, internalType: 'uint256', name: 'prevBps', type: 'uint256' },
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: false, internalType: 'address', name: 'prevVetoer', type: 'address' },
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'uint256', name: '_proposalThresholdBps', type: 'uint256' },
  ...
  },
  {
    ...
    name: 'state',
    outputs: [
      { internalType: 'enum GovernorTypesV1.ProposalState', name: '', type: 'uint8' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
  ...
  {
    inputs: [
      { internalType: 'uint256', name: '_newProposalThresholdBps', type: 'uint256' },
    ],
